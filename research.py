...
# =======================
OPENROUTER_API_KEY = "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" # Replace with your OpenRouter API key
SERPAPI_API_KEY = "603837b72f8d18b8d2240c555c2290899d1f2cc2ea89714a633aaeb2e9ea036d" # Replace with your SERPAPI API key
JINA_API_KEY = "jina_e9b1125ad7b547f5a7664429bb5e086fX0eLIcYdFuXEIMMNcXoHeH-I9gX9" # Replace with your JINA API key
...
async def async_main(user_query=None):
    if user_query is None:
        user_query = "Investigate enzymes that feature the Ser–His–Asp catalytic triad. Focus your analysis on how the active site is arranged structurally, including the enzyme's overall size, nearby secondary structures, and global fold architecture. Explain the specific distances that define the triad's geometry and compare different protein scaffolds that preserve this configuration. Include examples from well-characterized crystal structures that highlight how these catalytic residues remain spatially conserved across different folds and how that influences function."
    iter_limit_input = "1"
